...
encoder.set_function('activation', activation_sigmoid)
...
decoder.set_function('activation', activation_sigmoid)
...
for iteration in range(1, 200):
    ...
    model.fit(D_X_train, D_y_train, batch_size=BATCH_SIZE, nb_epoch=1,
              validation_data=(D_X_val, D_y_val), show_accuracy=True, verbose=1)
    ###
