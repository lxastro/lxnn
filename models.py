...
class Sequential(Model, containers.Sequential):
    ...
    def compile(self, optimizer, loss,
        ...
        print('X_train:', P.pprint(self.X_train))
        print('X_test:', P.pprint(self.X_test))
        print('y_train:')
        print(P.debugprint(self.y_train))
        print('y_test:')
        print(P.debugprint(self.y_test))
        ...
        _train_loss = weighted_loss(self.y, _y_train, self.weights, mask)
        _test_loss = weighted_loss(self.y, _y_test, self.weights, mask)
        ...
        _train_accuracy = K.mean(K.equal(K.argmax(self.y, axis=-1), K.argmax(_y_train, axis=-1)))
        _test_accuracy = K.mean(K.equal(K.argmax(self.y, axis=-1), K.argmax(_y_test, axis=-1)))
